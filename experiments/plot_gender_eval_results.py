...
CUSTOM_LABELS = {
    ...
    "checkpoints_act_cls_latentqa_pretrain_mix_gemma-2-9b-it": "Past Lens + LatentQA + Classification Pretrain Mix",
    "checkpoints_latentqa_only_gemma-2-9b-it": "LatentQA Only",
}
